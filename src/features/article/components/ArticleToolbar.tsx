...
export default function ArticleToolbar({
  ...
  const alignmentProgress = useSharedValue(
    fabVisible && !isLargeScreen ? 1 : 0
  );
  ...
  const fabTotalWidth =
    fabWidth + fabRightSpacing + spacingBetweenFabAndToolbar;
  ...
  const toolbarAnimatedStyle = useAnimatedStyle(() => {
    ...
    const maxWidth =
      alignmentProgress.value * toolbarMaxWidth +
      (1 - alignmentProgress.value) * centeredMaxWidth;
